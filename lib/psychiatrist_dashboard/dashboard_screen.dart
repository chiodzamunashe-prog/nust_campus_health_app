            ...
            itemBuilder: (context, index) {
              ...
              return FutureBuilder<Patient?>(
                ...
                builder: (c, psnap) {
                  ...
                  if (_searchQuery.isNotEmpty && !patientName.toLowerCase().contains(_searchQuery)) {
                        ...
                        Row(
                          children: [
                            ...
                            if (appt.status == 'pending') ...[
                              TextButton(
                                onPressed: () => repository.updateAppointmentStatus(appt.id, 'confirmed'),
                                child: const Text('Accept'),
                              ),
                              TextButton(
                                onPressed: () => repository.updateAppointmentStatus(appt.id, 'declined'),
